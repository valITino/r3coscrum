...
- [OFFEN] Künftige methodische Entscheide: Dieses Dokument wird
  ...
  Entscheid.
- [OFFEN] **O-25, Messumfang und Trennschärfe maschinell erzwingen** (neu am
  2026-09-03, hängt an V14). Zwei Prüfer haben unabhängig dasselbe
  vorgeschlagen: eine Kanalspalte in der Prüftabelle mit festem Wertevorrat,
  die der Selbsttest gegen die tatsächlich benutzte Messart abgleicht, und je
  Zusicherung eine Mutationsprobe, die der Selbsttest ausführt. Als
  methodischer Entscheid käme hinzu: "Eine Prüfung ist erst dann Beleg, wenn
  sie ihre eigene Verneinung erkennt." Entscheid des Auftraggebers.
